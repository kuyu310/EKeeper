...
#define CancelStrImgaeName @"tabbar_compose_review"
...
- (void)initUIsize
{
    ...
    bottomView.frame = CGRectMake(0, CGRectGetMaxY(self.bounds) - 78, kW, 78);
    [bottomView setBackgroundColor:[UIColor colorWithWhite:1.f alpha:0.30f]];
